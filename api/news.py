...
COUNTRY_CITIES = {
    "South Korea": [("서울",["seoul","서울"]),("부산",["busan","부산"]),("인천",["incheon","인천"]),
        ...
        ("창원",["changwon","창원"]),("당진",["dangjin","당진"]),("광양",["gwangyang","광양"]),
        ("평택",["pyeongtaek","평택"]),("거제",["geoje","거제"]),("제주",["jeju","제주"]),("경기",["gyeonggi","경기"])],
    "Japan": [("도쿄",["tokyo","도쿄"]),("오사카",["osaka","오사카"]),("요코하마",["yokohama"]),
        ("나고야",["nagoya"]),("후쿠오카",["fukuoka"]),("삿포로",["sapporo"]),("센다이",["sendai"]),
        ("오키나와",["okinawa","오키나와"]),("고베",["kobe"]),("교토",["kyoto"]),("히로시마",["hiroshima"]),
        ("후쿠시마",["fukushima","후쿠시마"]),("가와사키",["kawasaki"]),("지바",["chiba"])],
    ...
    "United States": [("뉴욕",["new york"]),("로스앤젤레스",["los angeles"]),("휴스턴",["houston"]),
        ...
        ("뉴올리언스",["new orleans"]),("시애틀",["seattle"]),("보스턴",["boston"]),("애틀랜타",["atlanta"]),
        ("마이애미",["miami"]),("댈러스",["dallas"]),("필라델피아",["philadelphia"]),("오하이오",["ohio"]),
        ("조지아",["georgia"]),("애리조나",["arizona"]),("네바다",["nevada"]),("오리건",["oregon"]),
        ("콜로라도",["colorado"]),("알래스카",["alaska"]),("하와이",["hawaii"]),("뉴저지",["new jersey"])],
    "Canada": [("토론토",["toronto"]),("밴쿠버",["vancouver"]),("몬트리올",["montreal"]),
        ("캘거리",["calgary"]),("오타와",["ottawa"]),("앨버타",["alberta"]),("브리티시컬럼비아",["british columbia"]),
        ("에드먼턴",["edmonton"]),("퀘벡",["quebec"]),("온타리오",["ontario"]),("매니토바",["manitoba"])],
    "Mexico": [("멕시코시티",["mexico city"]),("과달라하라",["guadalajara"]),("몬테레이",["monterrey"]),
        ("티후아나",["tijuana"]),("베라크루스",["veracruz"]),("칸쿤",["cancun"]),("푸에블라",["puebla"]),("후아레스",["juarez"])],
    "Germany": [("베를린",["berlin"]),("뮌헨",["munich"]),("함부르크",["hamburg"]),("프랑크푸르트",["frankfurt"]),
        ("쾰른",["cologne"]),("슈투트가르트",["stuttgart"]),("뒤셀도르프",["dusseldorf"]),("라이프치히",["leipzig"])],
    "France": [("파리",["paris"]),("마르세유",["marseille"]),("리옹",["lyon"]),("툴루즈",["toulouse"]),
        ("보르도",["bordeaux"]),("릴",["lille"]),("스트라스부르",["strasbourg"])],
    "India": [("델리",["delhi"]),("뭄바이",["mumbai"]),("첸나이",["chennai"]),("콜카타",["kolkata"]),
        ("벵갈루루",["bengaluru","bangalore"]),("하이데라바드",["hyderabad"]),("아마다바드",["ahmedabad"]),
        ("푸네",["pune"]),("케랄라",["kerala"])],
    "Indonesia": [("자카르타",["jakarta"]),("수라바야",["surabaya"]),("발리",["bali"]),("수마트라",["sumatra"]),
        ("술라웨시",["sulawesi"]),("반둥",["bandung"]),("메단",["medan"]),("자바",["java"]),("보르네오",["borneo"])],
    "Australia": [("시드니",["sydney"]),("멜버른",["melbourne"]),("브리즈번",["brisbane"]),("퍼스",["perth"]),
        ("캔버라",["canberra"]),("애들레이드",["adelaide"]),("퀸즐랜드",["queensland"]),("뉴사우스웨일스",["new south wales"])],
    "United Kingdom": [("런던",["london"]),("맨체스터",["manchester"]),("버밍엄",["birmingham"]),("스코틀랜드",["scotland"]),
        ("리버풀",["liverpool"]),("글래스고",["glasgow"]),("리즈",["leeds"]),("웨일스",["wales"])],
    "Brazil": [("상파울루",["sao paulo"]),("리우데자네이루",["rio de janeiro"]),("브라질리아",["brasilia"]),
        ("살바도르",["salvador"]),("벨루오리존치",["belo horizonte"])],
    "Vietnam": [("하노이",["hanoi"]),("호치민",["ho chi minh"]),("다낭",["da nang"]),("하이퐁",["hai phong"])],
    "Thailand": [("방콕",["bangkok"]),("푸껫",["phuket"]),("치앙마이",["chiang mai"])],
    "Philippines": [("마닐라",["manila"]),("세부",["cebu"]),("다바오",["davao"])],
    "Malaysia": [("쿠알라룸푸르",["kuala lumpur"]),("페낭",["penang"]),("조호르",["johor"])],
    "Taiwan": [("타이베이",["taipei"]),("가오슝",["kaohsiung"]),("타이중",["taichung"])],
    "Hong Kong": [("카오룽",["kowloon"])],
    "Chile": [("산티아고",["santiago"]),("발파라이소",["valparaiso"])],
    "Argentina": [("부에노스아이레스",["buenos aires"]),("코르도바",["cordoba"])],
    "Netherlands": [("암스테르담",["amsterdam"]),("로테르담",["rotterdam"]),("헤이그",["the hague"])],
    "Spain": [("마드리드",["madrid"]),("바르셀로나",["barcelona"]),("발렌시아",["valencia"]),("세비야",["seville"])],
    "Italy": [("로마",["rome"]),("밀라노",["milan"]),("나폴리",["naples"]),("토리노",["turin"]),
        ("베네치아",["venice"]),("시칠리아",["sicily"])],
    "Ireland": [("더블린",["dublin"])],
    "Poland": [("바르샤바",["warsaw"]),("크라쿠프",["krakow"])],
    "Sweden": [("스톡홀름",["stockholm"]),("예테보리",["gothenburg"])],
    "Turkey": [("이스탄불",["istanbul"]),("앙카라",["ankara"]),("이즈미르",["izmir"])],
    "United Arab Emirates": [("두바이",["dubai"]),("아부다비",["abu dhabi"]),("샤르자",["sharjah"])],
    "Israel": [("텔아비브",["tel aviv"]),("예루살렘",["jerusalem"]),("하이파",["haifa"])],
    "Egypt": [("카이로",["cairo"]),("알렉산드리아",["alexandria"]),("수에즈",["suez"])],
    "South Africa": [("요하네스버그",["johannesburg"]),("케이프타운",["cape town"]),("더반",["durban"]),("프리토리아",["pretoria"])],
